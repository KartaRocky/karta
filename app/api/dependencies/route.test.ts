...
describe("GET /api/dependencies", () => {
  it("should register a source successfully", async () => {
    ...
    mockSave.mockResolvedValueOnce([
      {
        source: {
          url: "https://git.svt.se/data/playground/karta-test-thiago",
          repository_name: "karta-test-thiago",
          repository_owner: "data",
          path_with_namespace: "data/playground/karta-test-thiago",
          created_at: "2024-11-08 13:23:11",
        },
        dependencies: [
          {
            id: 1,
