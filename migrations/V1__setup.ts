...
export async function up(db: Kysely<any>): Promise<void> {
  ...
  await db.schema
    ...
    .addPrimaryKeyConstraint('pk_sources_dependencies', ['source_id', 'dependency_id'])
    .addForeignKeyConstraint('fk_sources_dependencies_source', ['source_id'], 'sources', ['url'], (oc) => oc.onDelete('cascade'))
    .addForeignKeyConstraint('fk_sources_dependencies_dependency', ['dependency_id'], 'dependencies', ['id'], (oc) => oc.onDelete('cascade'))
    .execute()
